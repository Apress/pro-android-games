...
void SpawnNewObj(unsigned tilex, unsigned tiley, int state) /* stateenum */
{
	...
	new->state = state;
	if (w0 == true || w1 == true){
		if (gamestatesWL6[state].tictime)
			new->ticcount = US_RndT () % gamestatesWL6[state].tictime;
		else
			new->ticcount = 0;
	} else {
		if (gamestatesSOD[state].tictime)
			new->ticcount = US_RndT () % gamestatesSOD[state].tictime;
		else
			new->ticcount = 0;
	}
...
void NewState(objtype *ob, int state) /* stateenum */
{
	ob->state = state;
	if (w0 == true || w1 == true){
		ob->ticcount = gamestatesWL6[state].tictime;
	} else {
		ob->ticcount = gamestatesSOD[state].tictime;
	}
}
...
void KillActor (objtype *ob)
{
	...
	case guardobj:
		GivePoints (100);
		if (w0 == true || w1 == true){
			NewState (ob,s_grddie1WL6);
		} else {
			NewState (ob,s_grddie1SOD);
		}
	...
	case officerobj:
		GivePoints (400);
		if (w0 == true || w1 == true){
			NewState (ob,s_ofcdie1WL6);
		} else {
			NewState (ob,s_ofcdie1SOD);
		}
		PlaceItemType (bo_clip2,tilex,tiley);
		break;
	...
	case mutantobj:
		GivePoints (700);
		if (w0 == true || w1 == true){
			NewState (ob,s_mutdie1WL6);
		} else {
			NewState (ob,s_mutdie1SOD);
		}
		PlaceItemType (bo_clip2,tilex,tiley);
		break;
	...
	case ssobj:
		GivePoints (500);
		if (w0 == true || w1 == true){
			NewState (ob,s_ssdie1WL6);
		} else {
			NewState (ob,s_ssdie1SOD);
		}
	...
	case dogobj:
		GivePoints (200);
		if (w0 == true || w1 == true){
			NewState (ob,s_dogdie1WL6);
		} else {
			NewState (ob,s_dogdie1SOD);
		}
		break;
...
//
	...
	else
	{
		...
		case guardobj:
			if (w0 == true || w1 == true){
				if (ob->hitpoints&1)
					NewState (ob,s_grdpainWL6);
				else
					NewState (ob,s_grdpain1WL6);
				break;
			} else {
				if (ob->hitpoints&1)
					NewState (ob,s_grdpainSOD);
				else
					NewState (ob,s_grdpain1SOD);
				break;
			}
		...
		case officerobj:
			if (w0 == true || w1 == true){
				if (ob->hitpoints&1)
					NewState (ob,s_ofcpainWL6);
				else
					NewState (ob,s_ofcpain1WL6);
				break;
			} else {
				if (ob->hitpoints&1)
					NewState (ob,s_ofcpainSOD);
				else
					NewState (ob,s_ofcpain1SOD);
				break;
			}
		...
		case mutantobj:
			if (ob->hitpoints&1)
				if (w0 == true || w1 == true){
					NewState (ob,s_mutpainWL6);
				} else {
					NewState (ob,s_mutpainSOD);
				}
			else
				if (w0 == true || w1 == true){
					NewState (ob,s_mutpain1WL6);
				} else {
					NewState (ob,s_mutpain1SOD);
				}
			break;
		...
		case ssobj:
			if (ob->hitpoints&1)
				if (w0 == true || w1 == true){
					NewState (ob,s_sspainWL6);
				} else {
					NewState (ob,s_sspainSOD);
				}
			else
				if (w0 == true || w1 == true){
					NewState (ob,s_sspain1WL6);
				} else {
					NewState (ob,s_sspain1SOD);
				}
...
//
	...
	case guardobj:
		if (w0 == true || w1 == true){
			PlaySoundLocActor(HALTSNDWL6,ob);
			NewState (ob,s_grdchase1WL6);
		} else {
			PlaySoundLocActor(HALTSNDSOD,ob);
			NewState (ob,s_grdchase1SOD);
		}
	...
	case officerobj:
		if (w0 == true || w1 == true){
			PlaySoundLocActor(SPIONSNDWL6,ob);
			NewState (ob,s_ofcchase1WL6);
		} else {
			PlaySoundLocActor(SPIONSNDSOD,ob);
			NewState (ob,s_ofcchase1SOD);
		}
	...
	case mutantobj:
		if (w0 == true || w1 == true){
			NewState (ob,s_mutchase1WL6);
		} else {
			NewState (ob,s_mutchase1SOD);
		}
		ob->speed *= 3;			// go faster when chasing player
		break;
	...
	case ssobj:
		if (w0 == true || w1 == true){
			PlaySoundLocActor(SCHUTZADSNDWL6,ob);
			NewState (ob,s_sschase1WL6);
		} else {
			PlaySoundLocActor(SCHUTZADSNDSOD,ob);
			NewState (ob,s_sschase1SOD);
		}
	...
	case dogobj:
		if (w0 == true || w1 == true){
			PlaySoundLocActor(DOGBARKSNDWL6,ob);
			NewState (ob,s_dogchase1WL6);
		} else {
			PlaySoundLocActor(DOGBARKSNDSOD,ob);
			NewState (ob,s_dogchase1SOD);
		}
		ob->speed *= 2;			// go faster when chasing player
		break;

	case bossobj:
		SD_PlaySoundWL6(GUTENTAGSND);
		NewState (ob,s_bosschase1);
		ob->speed = SPDPATROL*3;	// go faster when chasing player
		break;

	case gretelobj:
		SD_PlaySoundWL6(KEINSND);
		NewState (ob,s_gretelchase1);
		ob->speed *= 3;			// go faster when chasing player
		break;

	case giftobj:
		SD_PlaySoundWL6(EINESND);
		NewState (ob,s_giftchase1);
		ob->speed *= 3;			// go faster when chasing player
		break;

	case fatobj:
		SD_PlaySoundWL6(ERLAUBENSND);
		NewState (ob,s_fatchase1);
		ob->speed *= 3;			// go faster when chasing player
		break;

	case schabbobj:
		SD_PlaySoundWL6(SCHABBSHASND);
		NewState (ob,s_schabbchase1);
		ob->speed *= 3;			// go faster when chasing player
		break;

	case fakeobj:
		SD_PlaySoundWL6(TOT_HUNDSND);
		NewState (ob,s_fakechase1);
		ob->speed *= 3;			// go faster when chasing player
		break;

	case mechahitlerobj:
		SD_PlaySoundWL6(DIESND);
