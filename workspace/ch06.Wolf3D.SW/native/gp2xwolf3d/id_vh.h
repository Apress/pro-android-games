...
extern pictabletype pictableWL1[NUMPICSWL1];
extern pictabletype pictableWL6[NUMPICSWL6];
extern pictabletype pictableSDM[NUMPICSSDM];
extern pictabletype pictableSOD[NUMPICSSOD];
...
#define VW_FadeInWL6()		VL_FadeIn(0,255,gamepalWL6,30);
#define VW_FadeInSOD()		VL_FadeIn(0,255,gamepalSOD,30);
